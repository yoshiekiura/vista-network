...
<div class="content-header row">
  <div class="content-header-left col-md-6 col-12 mb-2">
    <h3 class="content-header-title">Notification URL</h3>
...
<div class="content-body">
    ...
    <section id="global-settings" class="card">
      <div class="card-header">
        <h4 class="card-title">Funds Deposit Request Notification</h4>
      ...
      <div class="card-content">
        <div class="card-body">
          <div class="card-text">
            <h3 class="text-success">Thank you for your Funds Deposit from Alfa Coins</h3>

...
<div class="content-header row">
  <div class="content-header-left col-md-6 col-12 mb-2">
    <h3 class="content-header-title">BitCoin Payment</h3>
    <div class="row breadcrumbs-top">
      <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">BitCoin Payment
          </li>
        </ol>
      </div>
    </div>
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    <div class="card-text">
                      ...
                      <h3>Please Send EXACTLY <span style="color:red">{{ $bitcoin['amount']}} </span>BTC 
                        <br> TO <span style="color:red">{{ $bitcoin['sendto']}} </span>
                      </h3>
                      <br>  
                      <br>
                      <h2>SCAN TO SEND</h2>

...
<form class="form-horizontal" method="post" action="{{ URL::route('profile.update') }}" enctype="multipart/form-data">
{{ csrf_field() }}
{{method_field('put')}}
      ...
      <div class="sidebar-content card d-none d-lg-block">
        <div class="card-body">
          ...
          <div class="text-center">
            @if(Auth::user()->image == '')
                <img class="card-img-top mb-1 img-fluid" src="{{ asset('assets/images/user_profile_pic/default.jpg') }}">
            @else
                <img class="card-img-top mb-1 img-fluid" src="{{ asset('assets/images/user_profile_pic/'. Auth::user()->image) }}">
            @endif

...
<div class="content-body">
    ...
    <section id="global-settings" class="card">
      <div class="card-header">
        <h4 class="card-title">Product Purchase Complete</h4>
      ...
      <div class="card-content">
        <div class="card-body">
          <div class="card-text">
            <h3 class="text-success">Thank you for your order ({{ $order_id }})</h3>
            <p>An order confirmation will be emailed as soon as the order has been processed.</p>

                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green bold uppercase">Edit {{$product_->title}} </span>
                            </div>
                        </div>
                        <div class="portlet-body">
                                <form class="form-horizontal" role="form" method="POST" action="{{route('product.update.pranto', $product_->id)}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    {{method_field('put')}}
                                                ...
                                                <div class="description" style="width: 100%;border: 1px solid #ddd;padding: 10px;border-radius: 5px" >
                                                    <div class="row">
                                                        <div class="col-md-12" id="planDescriptionContainer">
                                                            @foreach($product_->product as $image)
                                                                <input type="hidden" name="image_id[]" value="{{$image->id}}">
                                                            <div class="input-group" data-value="{{$image->id}}">
                                                                <div class="left">
                                                                    <img class="img-uploaded" id="preview1"  src="{{ asset('assets/images/product/'.$image->image) }}" alt="your image" />
                                                                </div>
                                                                <div class="right">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control " value="{{$product_->title}}" type="text" required name="title">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="{{$product_->price}}" required name="price" >
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control " value="{{$product_->advance}}" type="number" name="advance">
                                                    <span class="input-group-addon">{{$general->currency}}</span>
                                                </div>    
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" value="{{$product_->duration}}" name="duration" >
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" name="description" >{!! $product_->description !!}</textarea>
                                            </div>
                                        </div>
                                    </div>

...
@section('main-content')
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title uppercase bold"> Product Managment
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @foreach($data->product as $image)
                                                    <img height="80px" src="{{ asset('assets/images/product/'.$image->image) }}">
                                                @endforeach
                                            </td>

                                            <td>
                                                <a class="btn green-meadow" href="{{route('product.edit', $data->id)}}"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="{{route('product.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="advance" placeholder="Advance Payment" name="advance" >
                                            <span class="input-group-addon">{{$general->currency}}</span>
                                        </div>
                                        </div>
                                    </div>

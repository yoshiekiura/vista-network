                        ...
                        <div class="portlet-body form">
                            <form method="POST" action="{{route('commission.update', $charge->id)}}" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="form-group col-md-3">
                                            <strong class="col-md-12">HP/LP Daily Commission:
                                            </strong>
                                            <div class="input-group">
                                                <input type="text" class="form-control" required name="hp_comission"  value="{{$charge->hp_commission}}">
                                                <span class="input-group-addon" id="start-date"><i class="fas fa-percent"></i></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        <strong class="col-md-12 ">HP FAST MINER BONUS Commission:
                                        </strong>
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="hp_miner_bonus"  value="{{$charge->hp_miner_bonus}}">
                                            <span class="input-group-addon" id="start-date"><i class="fas fa-percent"></i></span>
                                        </div>
                                    </div>

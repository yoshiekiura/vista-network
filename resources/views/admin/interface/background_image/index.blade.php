                                    ...
                                    <form method="post"  action="{{route('image.background.update')}}" enctype="multipart/form-data">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-md-4 col-sm-12 size-bar">
                                               <div class="portlet box blue-ebonyclay">
                                                   <div class="portlet-title">
                                                       <div class="caption">Join Us Panel</div>
                                                   </div>
                                                   <div class="portlet-body">
                                                       <img src="{{asset('assets/fonts/img/call-to-action.png')}}" alt="IMG" style="width:100%;"><br/>
                                                       <h4 class="bold">Join Background Image </h4>
                                                       <span class="badge badge-success">1000px * 600px Standard</span><br><br>
                                                       <input type="file" class="form-control" name="join">
                                                   </div>
                                               </div>
                                           </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12 size-bar">
                                                <div class="portlet box blue-ebonyclay">
                                                    <div class="portlet-title">
                                                        <div class="caption">Payment Method Panel</div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        <img src="{{asset('assets/fonts/img/payment-bg.jpg')}}" alt="IMG" style="width:100%;"><br/>
                                                        <h4 class="bold">Payment Background Image </h4>

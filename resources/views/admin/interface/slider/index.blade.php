    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title uppercase bold"> Slider Settings
                <a class="btn blue btn-md pull-right" data-toggle="modal" href="#basic">
                                    ...
                                    @foreach($slider as $data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn red" type="button" data-toggle="modal" data-target="#deleteModal{{$data->id}}"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                            </td>
                                        </tr>
                                        <div id="deleteModal{{$data->id}}" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{route('slide.delete', $data->id)}}" class="btn red"><i class="fa fa-trash"></i> Delete</a>
                                                </div>
                                            </div>
                                        </div>

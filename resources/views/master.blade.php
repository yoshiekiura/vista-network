...
<div class="preloader">
    <div class="preloader-wrapper">
        <div class="preloader-img">
            <img  src="{{asset('assets/images/Loader.gif')}}" alt="Preloader Image">
        </div>
    </div>
</div>
<!--preloader end-->
<div class="page-header navbar navbar-fixed-top" style="background-color: #190000;">
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            ...
            <a href="">
                <img class="logo" style="height: 30px; width: 80px; margin-top: 6px; margin-bottom: 0px;" src="{{asset('assets/images/fontend_logo/logo.png')}}"> 
            </a>
    ...
    <div class="modal-content">
        ...
        <form class="form-horizontal" role="form" method="post" action="{{route('generate.match')}}">
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <strong class="col-md-12">POTENTIAL MEMBER:{{ \App\MemberExtra::where('left_bv', '>=', 1)->where('right_bv', '>=', 1)->count() }}</strong>
                    <div class="col-md-12">
            ...
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn red">Latter</button>
